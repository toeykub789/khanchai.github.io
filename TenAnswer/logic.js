  ...
  if (values != " ") {
    ...
    if (round < 10) {
      if (values === storedRandom) {
        ...
        document.getElementById("hint").innerText = "Answer 11 - 20";
        ...
        document.getElementById("hint").innerText = "Answer 31 - 40";
  ...
  if (valueInput != " ") {
    ...
    if (round < 10) {
      if (valueInput == randomStored) {
        ...
        document.getElementById("hint").innerText = "Answer 51 - 60";
      } else if (randomStored >= 61 && randomStored <= 70 && round > 4) {
        document.getElementById("hint").innerText = "Answer 61 - 70";
      } else if (randomStored >= 71 && randomStored <= 80 && round > 4) {
        document.getElementById("hint").innerText = "Answer 71 - 80";
      } else if (randomStored >= 81 && randomStored <= 90 && round > 4) {
        document.getElementById("hint").innerText = "Answer 81 - 90";
      } else if (randomStored >= 91 && randomStored <= 100 && round > 4) {
        document.getElementById("hint").innerText = "Answer 91 - 99";
      }
      round++;
    } else if (round == 10) {
      if (valueInput === randomStored) {
